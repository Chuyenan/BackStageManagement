...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<section class="wrapper">
		...
		<header class="main-header">
			<!-- Logo -->
			<a href="${pageContext.request.contextPath}/pages/mainCustomer.jsp" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="${pageContext.request.contextPath}/pages/mainCustomer.jsp" class="btn btn-default btn-flat">回到首页</a>
									</div>
									<div class="pull-right">
										<a href="${pageContext.request.contextPath}/user/LogoutCustomer"
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li id="admin-index"><a
							href="${pageContext.request.contextPath}/pages/mainCustomer.jsp"><i
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					...
					当前用户: <a>${currentAdmin.userName} </a>
				</h1>
				<ol class="breadcrumb">
				...
				<div class="col-md-8">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#timeline" data-toggle="tab">基本信息</a></li>
								<li><a href="#settings" data-toggle="tab">修改密码</a></li>
							</ul>
							<div class="tab-content">
								<div class="active tab-pane" id="timeline">
									<div class="form-horizontal" style="margin-right: 20px;margin-top: 20px;padding-bottom: 20px">
										<div class="form-group">
											<label for="inputName" class="col-sm-2 control-label">ID</label>
											<div class="col-sm-10">
												<input type="email" value="${currentAdmin.userId}" class="form-control" id="inputName1" name="userId" placeholder="ID" disabled>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="email" value="${currentAdmin.email}" name="email" class="form-control" id="inputEmail" placeholder="Email" disabled>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" value="${currentAdmin.userName}" class="form-control" id="inputName" name="userName" placeholder="Name" disabled>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" value="${currentAdmin.updateTime}" class="form-control" id="inputSkills" placeholder="updateTime" disabled>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-offset-2 col-sm-4">
												<a href="../pages/modifyCustomer.jsp" class="btn btn-instagram">编辑信息</a>
											</div>
											<div class="col-sm-offset-2 col-sm-4">
												<button type="submit" class="btn btn-danger"
														onclick="logOffAlert()">注销</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="tab-pane" id="settings">
									<form action="${pageContext.request.contextPath}/user/ModifyPW?userId=${currentAdmin.userId}" method="post" class="form-horizontal">
										<div class="form-group">
											<label for="inputName" class="col-sm-2 control-label">原密码</label>
											<div class="col-sm-10">
												<input type="password" name="formerPWD" class="form-control" id="password1" placeholder="原密码">
											</div>
										</div>
										<div class="form-group">
											<label for="inputName" class="col-sm-2 control-label">新密码</label>
											<div class="col-sm-10">
												<input type="password" name="newPWD" class="form-control" id="password2" placeholder="新密码">
											</div>
										</div>
										<div class="form-group">
	...
	<script>
		function logOffAlert() {
			if (window.confirm("确定要注销吗？")){
				location.href="${pageContext.request.contextPath}/user/LogoffCustomer?userId=${currentAdmin.userId}";
			}
		}
	</script>
	<script type="text/javascript">
