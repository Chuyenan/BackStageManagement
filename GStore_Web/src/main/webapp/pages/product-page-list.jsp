								...
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新"
												onclick="location.href='${pageContext.request.contextPath}/product/FindAllProduct?pageNum=1&pageSize=4'">
...
<%--												href="${pageContext.request.contextPath}/product/DeleteProductById?productId=${product.productId}"--%>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/product/FindAllProduct?pageNum=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/product/FindAllProduct?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a></li>
								<c:if test="${pageInfo.pages<=5}">
									<c:forEach begin="1" end="${pageInfo.pages}" var="var">
										<li><a href="${pageContext.request.contextPath}/product/FindAllProduct?pageNum=${var}&pageSize=${pageInfo.pageSize}">${var}</a></li>
									</c:forEach>
								</c:if>
								<c:if test="${pageInfo.pages>5}">
								...
								<li><a href="${pageContext.request.contextPath}/product/FindAllProduct?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/product/FindAllProduct?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
					</div>
					<!-- /.box-footer-->
	...
	<script>
		...
		function changePageSize() {
			...
			//向服务器发送请求，改变没页显示条数
			location.href = "${pageContext.request.contextPath}/product/FindAllProduct?pageNum=1&pageSize="
					+ pageSize;
		}
		function changePageNum() {
			...
			//向服务器发送请求，改变当前页数
			location.href = "${pageContext.request.contextPath}/product/FindAllProduct?pageNum=" + pageSize +
