...
<%--		<jsp:include page="aside.jsp"/>--%>
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a href="mainCustomer.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
				...
				<div class="col-md-8">
					<div class="nav-tabs-custom">
						...
						<div class="tab-pane" id="settings">
							<form class="form-horizontal" action="${pageContext.request.contextPath}/user/ModifyCustomer" method="post" style="margin-right: 20px;margin-top: 20px;padding-bottom: 20px">
