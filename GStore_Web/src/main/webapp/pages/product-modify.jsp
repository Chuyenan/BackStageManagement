...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/product/ModifyProductById"
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productId"
								   placeholder="商品ID" value="${product.productId}" readonly>
						</div>
						<div class="col-md-2 title">商品名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productName"
								   placeholder="商品名称" value="${product.productName}">
						</div>
						...
						<div class="col-md-4 data">
							...
							<input type="file" style="margin-left: 10px;padding-top: 5px" name="imgFile">
						</div>
