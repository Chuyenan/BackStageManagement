...
<%--							<!--工具栏/-->--%>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="${pageContext.request.contextPath}/orders/findAll?pageNum=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
							...
							<c:if test="${pageInfo.pages<=5}">
								<c:forEach begin="1" end="${pageInfo.pages}" var="var">
									<li><a href="${pageContext.request.contextPath}/orders/findAll?pageNum=${var}&pageSize=${pageInfo.pageSize}">${var}</a></li>
								</c:forEach>
							</c:if>
							<c:if test="${pageInfo.pages>5}">
							...
							<li><a href="${pageContext.request.contextPath}/orders/findAll?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
                    </div>
	...
	<script>
		...
		function changePageNum() {
			...
			//向服务器发送请求，改变当前页数
			location.href = "${pageContext.request.contextPath}/orders/findAll?pageNum=" + pageSize +
