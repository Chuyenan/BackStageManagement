...
<header class="main-header">
	...
	<a class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		...
		<span class="logo-lg"><b>数据</b>登录错误页面</span>
	</a>
	...
	<!-- /.sidebar -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a href="${pageContext.request.contextPath}/user/LogoutCustomer"><i
							class="fa fa-dashboard"></i> 重新登录</a></li>
			...
			<section class="content">
				<div class="error-page">
					...
					<div class="error-content">
						...
						<p>
							登录失败 , 你可以 <a href="${pageContext.request.contextPath}/user/LogoutCustomer">返回到登录页面</a>
							重新登录
						</p>
