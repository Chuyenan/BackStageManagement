		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li id="admin-index"><a
							href="${pageContext.request.contextPath}/pages/loginCustomer.jsp"><i
			...
			<section class="content">
				<div class="error-page">
					...
					<div class="error-content">
						<br>
						<h3><i class="fa fa-check-circle text-green"></i>Success!</h3>
						<h4>
							修改成功<br>
							你需要 <a href="${pageContext.request.contextPath}/user/LogoutCustomer">重新登录</a>
						</h4>
					</div>
					<!-- /.error-content -->
				</div>
