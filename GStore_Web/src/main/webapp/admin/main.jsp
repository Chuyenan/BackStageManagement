...
<body style="background: #f3f3f3;">
		...
		<div class="am-g">
			...
			<div class="am-u-sm-12 am-u-md-3">
				<div class="am-input-group am-input-group-sm">
					...
					<span class="am-input-group-btn"><button class="am-btn am-btn-default" type="button" id="input_search_btn">搜索</button>
					</span>
				</div>
			</div>
		</div>
	...
	<div class="goods_list">
		...
		<ul class="list_goods_ul">
			...
			<li>${goods.price }</li>
			<li>
				<a href="${ctx }/GoodsServlet?action=goodsEditUI&id=${goods.id}">
					<img class="img_icon" src="${ctx }/admin/images/edit_icon.png" >
				</a>
			</li>
			<li>
				<a href="${ctx }/GoodsServlet?action=goodsDel&id=${goods.id}">
				<img class="img_icon" src="${ctx }/admin/images/delete_icon.png">
				</a>
			</li>
		</ul>
		</c:forEach>
    ...
    $("#page").paging({
        ...
        callback: function(num) {
			$(window).attr('location',"${ctx}/GoodsServlet?action=getPageBean&currentPage=" + num);
        }
    });

    $("#add").click(function () {
        $(window).attr('location',"${ctx}/GoodsServlet?action=goodsAddUI");
    });
	</script>
