...
<div class="goods_list" id="account_List">
    ...
    <c:forEach items="${adminList}" var="admin" varStatus="status">
        <ul class="list_goods_ul">
            ...
            <li><a href="${ctx}/AdminBaseServlet?action=delAdmin&id=${admin.id}"><img class="img_icon" src="${ctx}/admin/images/delete_icon.png" alt=""></a></li>
        </ul>
    </c:forEach>
...
<div id="modal_content_account">
    ...
    <div class="edit_content">
        <form action="${ctx}/AdminBaseServlet?action=addAdmin" method="post" id="admin_add_form" style="background: none; width: 700px;">
            <div class="item1">
                <div>
                    <span>添加管理员：</span>
                </div>
            ...
            <div class="item1">
                <button class="am-btn am-btn-default" type="button" id="admin_add_button">添加</button>
            </div>
        </form>
