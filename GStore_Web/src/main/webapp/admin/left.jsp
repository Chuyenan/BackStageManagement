...
<ul>
    <li><a href="${ctx }/CategoryServlet?action=getCategoryPageBean" target="mainFrame"><i></i>分类管理</a></li>
    <li><a href="${ctx }/GoodsServlet?action=getPageBean&currentPage=1" target="mainFrame"><i></i>商品管理</a></li>
    <li></i><a href="${ctx}/AdminBaseServlet?action=adminList" target="mainFrame"><i></i>用户管理</a></li>
</ul>
